...
def get_title_and_category(filepath):    
    title_prompt = "Generate for me a 20 words professional objective and descriptive Title for this image as a 'Title' - Respond using JSON"  
...
def restartOllama():
    command = "$ollamaProc = Get-Process -Name \"ollama app\" -ErrorAction SilentlyContinue \n" 
